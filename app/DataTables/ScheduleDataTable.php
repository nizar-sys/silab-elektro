...
class ScheduleDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addIndexColumn()
            ->addColumn('action', 'console.schedules.action')
            ->rawColumns(['action']);
    }
    ...
    public function html(): HtmlBuilder
    {
        ...
        $language = [
            ...
            'info' => 'Menampilkan _START_ ke _END_ dari _TOTAL_ Jadwal',
        ];

        // Konfigurasi tombol
        $buttons = [
            [
                'text' => '<i class="ri-add-line me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Tambah Jadwal</span>',
            ...
            [
                ...
                'action' => 'function (e, dt, node, config) {
                    dt.ajax.reload();
                    $("#schedules-table_filter input").val("").keyup();
                }'
            ]
        ];
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('day')->title('Hari Jadwal'),
            Column::make('hour')->title('Jam Jadwal'),
