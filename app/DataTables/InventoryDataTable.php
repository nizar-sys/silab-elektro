...
class InventoryDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addIndexColumn()
            ->addColumn('action', 'console.inventories.action')
    ...
    {
        return $model->newQuery()->with('room');
    }
    ...
    public function html(): HtmlBuilder
    {
        ...
        $language = [
            ...
            'info' => 'Menampilkan _START_ ke _END_ dari _TOTAL_ Inventaris',
        ];

        // Konfigurasi tombol
        $buttons = [
            [
                'text' => '<i class="ri-add-line me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Tambah Inventaris</span>',
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('room.name')->title('Nama Ruangan'),
            Column::make('code')->title('Kode Inventaris'),
