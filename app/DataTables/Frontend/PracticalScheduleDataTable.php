...
class PracticalScheduleDataTable extends DataTable
{
    /**
        ...
        $buttons = [
            [
                ...
                'action' => 'function (e, dt, node, config) {
                    dt.ajax.reload();
                    $("#practicals-schedules-table_filter input").val("").keyup();
                }'
            ]
        ];

        return $this->builder()
            ->setTableId('practicals-schedules-table')
            ...
            ->ajax([
                'url'  => route('data.practical-schedules'),
                'type' => 'GET',
            ]);
    }
    ...
    {
        return 'PracticalSchedule_' . date('YmdHis');
    }
}
