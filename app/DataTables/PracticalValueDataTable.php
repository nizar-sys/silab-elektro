...
class PracticalValueDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addIndexColumn()
            ->addColumn('action', 'console.practical_values.action')
            ->rawColumns(['action']);
    }
    ...
    public function html(): HtmlBuilder
    {
        ...
        $buttons = [
            [
                'text' => '<i class="ri-add-line me-0 me-sm-1"></i><span class="d-none d-sm-inline-block">Tambah Nilai</span>',
        ...
        return $this->builder()
            ...
            ->ajax([
                'url'  => route('practical-values.index'),
                'type' => 'GET',
            ]);
    }
